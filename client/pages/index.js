...
import { FiMail, FiCopy, FiRefreshCw, FiTrash2, FiClock, FiUser, FiCheck, FiSettings, FiMenu, FiX, FiInbox, FiStar, FiCode, FiFileText } from 'react-icons/fi'
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Temporary email service with history and custom naming" />
      ...
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden">
        ...
        <aside className={`${
        ...
        } fixed lg:static inset-y-0 left-0 z-50 w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transform transition-transform duration-300 ease-in-out flex flex-col`}>
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-800 dark:text-white">TempMail</h1>
                <p className="text-xs text-gray-500 dark:text-gray-400">Unlimited & Free</p>
              </div>
            </div>
            <button
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            ...
            >
              ...
              <span>{loading ? 'Processing...' : useManualEmail ? 'Add Email' : emailAddress ? 'New Email' : 'Generate Email'}</span>
            </button>
          </div>
            ...
            <div className="border-b border-gray-200 dark:border-gray-700">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium text-gray-700 dark:text-gray-300">Saved Emails</span>
            ...
            <div className="flex-1 overflow-y-auto">
              {emails.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center p-8">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 font-medium">No emails yet</p>
                  <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
                    {emailAddress ? 'Waiting for messages...' : 'Generate an email to start'}
                  </p>
                </div>
              ) : (
                emails.map((email) => (
              ...
              {emailAddress ? (
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    {selectedEmail ? `From: ${selectedEmail.sender}` : `${emails.length} message${emails.length !== 1 ? 's' : ''}`}
                  </p>
                </div>
              ) : (
                <div>
                  <h1 className="text-lg font-semibold text-gray-800 dark:text-white">Welcome to TempMail</h1>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Generate a temporary email to get started</p>
                </div>
              )}
            </div>
          </header>
          ...
          <div className="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-900">
            {emailAddress ? (
              selectedEmail ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center p-8">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Choose a message from the sidebar to view its contents
                  </p>
                </div>
              )
            ) : (
              <div className="flex flex-col items-center justify-center h-full text-center p-8">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 rounded-lg max-w-md">
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    👈 Click <strong>"Generate Email"</strong> in the sidebar to create your temporary email address
                  </p>
                </div>
              </div>
            )}
